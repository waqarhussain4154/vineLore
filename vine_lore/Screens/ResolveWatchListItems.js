...
function Item({ item, props }) {
    return (
        <TouchableWithoutFeedback onPress={() => props.navigation.navigate('DetailResolveWatchListItems',{
            Id : item.Id,
        ...
        firestore()
            ...
            .then(querySnapshot => {
                ...
                querySnapshot.forEach(documentSnapshot => {
                    ...
                    if(documentSnapshot.data().DateDelivered==""){
                    li.push({
        ...
        return (
            <View style={styles.container}>
                <View style={styles.navView}>
                    ...
                    <TouchableOpacity>
                        <Text style={{ fontSize: RFPercentage(3.5), color: 'black', fontWeight: 'bold', }}>Resolve WatchList Ite... </Text>
                    </TouchableOpacity>
                    <TouchableOpacity>
                        <AntDesign
                            style={{ width: wp(8) }}
